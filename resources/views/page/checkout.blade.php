							...
							<div class="your-order-body" style="padding: 0px 10px">
								<div class="your-order-item">
									...
									@foreach($product_cart as $product)
										<div class="media">
											<img width="25%" src="{{ url('source/image/product/'.$product['item']['image'].'') }}" alt="" class="pull-left">
											<div class="media-body">
												<p class="font-large">{{$product['item']['name']}}</p>
												<span class="color-gray your-order-info">Số lượng: {{$product['qty']}}</span>
											</div>
										</div>
										@endforeach
									<!-- end one item -->
