...
<head>
    ...
    <link rel="stylesheet" href="{{ url('http://netdna.bootstrapcdn.com/bootstrap/3.1.0/css/bootstrap.min.css') }}">
...
<div id="header">
    ...
    @include('partial.header_body');
    @include('partial.header_bottom');
</div> <!-- #header -->
@yield('content')
...
<!-- include js files -->
<script src="{{ url('source/assets/dest/js/jquery.js') }}"></script>
...
<script src="{{ url('source/assets/dest/js/waypoints.min.js') }}"></script>
